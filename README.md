...
Разработку планируется вести на Java и Python, в зависимости от требований модулей и других особенностей проекта окончательный выбор может быть сделан в пользу одного из языков, или комбинации обоих в разных модулях.
